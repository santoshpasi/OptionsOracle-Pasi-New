...
namespace OptionsOracle.Data
{
    partial class ConfigSet
    {
        ...
        private const string REMOTE_CONFIG = @"config.xml";
        ...
        private string series_download = "Three";
        ...
        public string SeriesDownload
        {
            get { return series_download; }
            set { series_download = value; }
        }
        ...
        private bool New()
        {
            ...
            try
            {
                string[] AllTypes = new string[] { "Long Stock", "Short Stock", "Long Future", "Short Future", "Long Call", "Short Call", "Long Put", "Short Put" };
        ...
        public void UpdateLocalCache()
        {
            ...
            try
            {
                SeriesDownload = GetParameter("Series Download");
            }
            catch { SeriesDownload = "Three"; }
